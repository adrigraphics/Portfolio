...
const ConfidentasManual = () => {
    return (
        <div>
            <p id="confidentasManual" className='ibm-plex text-[20px] mb-5 mt-20 text-gray-400'>

                Las Confidentas // Manual de aborto seguro
...
export default ConfidentasManual